/* write a function to search a node in the array list
*/
class Node{
    int data;
    Node next;
...
temp=temp.next; //update the node
}
return false;
 }
}
public class searchinganodeinlist {
    public static void main(String[] args) {
        ...
        ListOfFunctions.display();
        boolean found=ListOfFunctions.search(60);
